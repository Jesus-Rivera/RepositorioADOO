...
<script>
	function confirmFunction(Direccion)
	{
		swal({
			title: 'Eliminar',
			text: "No podra recuperar este archivo",
			type: 'warning',
...
<script>
	function eliminado()
	{
		swal('Eliminado','El archivo se elimino con exito','success')
	}
</script>
<?php
	if(isset($_GET['ver']))
	{
		echo '<body onload="eliminado();">';
	}
	else
	{
		echo '<body>';
		...
		<article>
			...
			<?php
				...
				while($rows = mysqli_fetch_array($resultado))
				{
					...
					$cambio = 'eliminar.php?id='.$idA;
					echo '<a href="#" onclick = "confirmFunction('."'$cambio'".');">';
